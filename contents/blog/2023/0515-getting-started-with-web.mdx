...
Besides, there’s [a handy tool](https://screenspan.net/fallback) for the generation of fallback fonts. I mainly use it to adjust font declarations, which guarantees a harmonious pairing between the serif and sans-serif fonts.
...
For example, below is a normal paragraph with some _italic styling_:
...
> This is a blockquote example with the serif font “Spectral”:
>
> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent iaculis lorem sed nunc volutpat convallis. Morbi porttitor diam vel pellentesque gravida. Quisque vitae consequat ipsum.
>
> 以及中文。设备如安装了「楷体」或「华文楷体」，则会优先显示。
...
至于 [Safari 上的系统字体不能正常显示](https://stackoverflow.com/questions/52692905/font-family-display-issue-in-safari-12-on-macos-mojave)，是个极其恼人的问题。并非每个 Mac 用户都会使用第三方浏览器，想保证网页显示效果就最好内置字体，而 GBK 标准字库非常臃肿。
